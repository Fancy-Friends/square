 ...
 */
/**
 * Every Square node executor — the PHP twin of `SQUARE_RUNNABLE_KINDS` in
 * @particle-academy/square-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `SquareFlow::register($kinds, $executors)` — one call, no directory scan.
 ...
 */
final class SquareFlow
{
    /** @var list<class-string> */
    public const EXECUTORS = [
        PaymentCreateExecutor::class,
    ];
